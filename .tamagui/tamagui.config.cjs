...
var headingFont2 = createInterFont({
  size: {
    1: 12,
    2: 14,
    3: 15,
...
var bodyFont2 = createInterFont(
  ...
  {
    sizeSize: /* @__PURE__ */ __name((size3) => Math.round(size3 * 1.1), "sizeSize"),
    sizeLineHeight: /* @__PURE__ */ __name((size3) => Math.round(size3 * 1.1 + (size3 > 20 ? 10 : 4)), "sizeLineHeight")
  }
);
var customTokens = {
  ...config.tokens,
  color: {
    ...
    // Green-600
    primaryGreenLighter: "#6EE7B7",
    // Green-300
    // Gray colors to match current theme
    gray50: "#F9FAFB",
    gray200: "#E5E7EB",
    gray500: "#6B7280",
    gray700: "#374151",
...
var customThemes = {
  light: {
    ...
    backgroundHover: customTokens.color.gray50,
    backgroundPress: customTokens.color.gray200,
    backgroundFocus: customTokens.color.gray50,
    color: customTokens.color.gray900,
    colorHover: customTokens.color.gray900,
    colorPress: customTokens.color.gray900,
    colorFocus: customTokens.color.gray900,
    borderColor: customTokens.color.gray200,
    borderColorHover: customTokens.color.gray200,
    borderColorPress: customTokens.color.gray200,
    borderColorFocus: customTokens.color.primaryGreen,
    placeholderColor: customTokens.color.gray500,
    // Primary green theme
    primary: customTokens.color.primaryGreen,
    primaryHover: customTokens.color.primaryGreenDark,
    primaryPress: customTokens.color.primaryGreenDark,
    primaryFocus: customTokens.color.primaryGreen,
    // Surface colors
    surface1: customTokens.color.white,
    surface2: customTokens.color.gray50,
    surface3: customTokens.color.gray200
  },
  dark: {
    ...config.themes.dark,
    ...
    colorHover: customTokens.color.gray50,
    colorPress: customTokens.color.gray50,
    colorFocus: customTokens.color.gray50,
    borderColor: customTokens.color.gray700,
    borderColorHover: customTokens.color.gray700,
    borderColorPress: customTokens.color.gray700,
    borderColorFocus: customTokens.color.primaryGreenLight,
    placeholderColor: customTokens.color.grayLight,
    // Primary green theme (lighter for dark mode)
    primary: customTokens.color.primaryGreenLight,
    primaryHover: customTokens.color.primaryGreenLighter,
    primaryPress: customTokens.color.primaryGreenLighter,
    primaryFocus: customTokens.color.primaryGreenLight,
    // Surface colors
    surface1: customTokens.color.gray900,
    surface2: customTokens.color.gray800,
    surface3: customTokens.color.gray700
  }
};
var appConfig = (0, import_core3.createTamagui)({
  ...config,
  tokens: customTokens,
  themes: customThemes,
  fonts: {

...
Your data is securely stored using Supabase (PostgreSQL) and processed using secure AI endpoints. We implement industry-standard security measures to protect your data.

## 4. Third-Party Services
We use the following third-party services:
- **Supabase:** For authentication and database management.
- **RevenueCat:** For subscription management and payment processing.
- **OpenAI/Anthropic:** For AI-powered meal analysis (data sent is anonymized where possible).
